                    ...
                    <div class="card-body">
                        ...
                        <form method="post">
                            <div class="row mb-3">
                                ...
                                <div class="col-9">
                                    <input class="form-control" type="date" name="date" min="2000-01-01" max="2099-12-31" id="date" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-9">
                                    <input class="form-control" type="text" name="machine" id="machine" maxlength="20" placeholder="トレーニングマシンを入力" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-7">
                                    <input class="form-control" type="number" name="weight" id="weight" step="0.1" min="0" max="999.9" placeholder="0.0">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-7">
                                    <input class="form-control" type="number" name="time" id="time" min="0" max="99" placeholder="0">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-7">
                                    <input class="form-control" type="number" name="set_count" id="set_count" min="0" max="99" placeholder="0">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-9">
                                    <input class="form-control" type="text" name="note" id="note" size="50" maxlength="30">
